...
const OnboardingContent: React.FC<OnboardingStepProps> = ({
  ...
  return (
    <div style={{ lineHeight: 1.6 }}>
      ...
      <StyledText
        ...
        startDecorator={
          activeStep > 0 ? (
            ...
            <PendingIcon color={activeStep === 0 ? "warning" : "info"} />
          )
        }
      ...
      {activeStep === 0 && (
        <BusinessDetailsForm submit={onBusinessFormSubmit} />
      )}
      <Divider sx={{ my: 0.25 }} />
      <StyledText
        fontSize={20}
        ...
        startDecorator={
          activeStep > 1 ? (
            ...
            <PendingIcon color={activeStep === 1 ? "warning" : "info"} />
          )
        }
      >
      ...
      <StyledText
        ...
        startDecorator={
          activeStep > 2 ? (
            ...
            <PendingIcon color={activeStep === 2 ? "warning" : "info"} />
          )
        }
      >
      ...
      <StyledText
        ...
        startDecorator={
          activeStep > 3 ? (
            ...
            <PendingIcon color={activeStep === 3 ? "warning" : "info"} />
          )
        }
      >
      ...
      >
        <a
          href={t(
            "manager.onboarding.importantLinks.links.onboardingRequirements"
          )}
        >
      ...
      >
        <a
          href={t(
            "manager.onboarding.importantLinks.links.onlinePaymentsGuide"
          )}
        >
