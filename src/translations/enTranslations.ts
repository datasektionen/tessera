...
const enTranslations = {
 ...
 form: {
  ...
  ticket_release: {
   ...
   ticket_release_method_helperText: "How do you want to distribute tickets?",
 ...
 profile: {
  ...
  your_teams: {
   ...
   no_events: "There are no events in this team. Create one now <1>here</1>.",
   users: "Users",
