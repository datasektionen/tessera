...
const seTranslations = {
 ...
 form: {
  ...
  addon: {
   ...
   max_quantity_helperText: "Hur många av detta tillägg kan en användare köpa?",
 ...
 profile: {
  ...
  your_teams: {
   ...
   no_events: "Det finns inga händelser i denna grupp. Skapa en nu <1>här</1>.",
   users: "Användare",
 ...
 manage_event: {
  ...
  send_out: {
   ...
   message: "Meddelande",
   message_helperText: "Vad är innehållet i e-postmeddelandet? Markdown stöds.",
   preview_helperText:
 ...
 main_page: {
  ...
  page_description: {
   ...
   what:
    "Tessera är en plattform som gör biljettförsäljning enkel. Att köpa\
